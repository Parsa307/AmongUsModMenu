...
Usage:
Pass string literals into the OBFUSCATE macro to obfuscate them at compile
time. OBFUSCATE returns a reference to an ay::obfuscated_data object with the
following traits:
...
// See: https://developercommunity.visualstudio.com/t/-line-cannot-be-used-as-an-argument-for-constexpr/195665
	...
	#define OBFUSCATE_DEFAULT_KEY ay::generate_key(AY_LINE)
#endif
